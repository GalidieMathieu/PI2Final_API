...
class MultiTaskQAQGPipeline_fr(QGPipeline_fr):
...
SUPPORTED_TASKS = {
    "question-generation": {
        "impl": QGPipeline_fr,
        "default": {
            "model": "JDBN/t5-base-fr-qg-fquad",
            "ans_model": "JDBN/t5-base-fr-qg-fquad",
        }
    },
    "multitask-qa-qg": {
        "impl": MultiTaskQAQGPipeline_fr,
        "default": {
            "model": "JDBN/t5-base-fr-qg-fquad",
        }
    },
    "e2e-qg": {
        "impl": E2EQGPipeline_fr,
        "default": {
            "model": "JDBN/t5-base-fr-qg-fquad",
        }
    }
